...
public class SimplificationFactory {
    /**
     * @param simplificationType
     * @return desired simplifier object
     */
    public Simplifier getSimplifier(String simplificationType){
      if(simplificationType.equalsIgnoreCase("Ramer-Douglas-Peucker")){
         return new RDPsimplifier();  
      }
